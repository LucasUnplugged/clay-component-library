...
const clayTheme = {
  button: {
    ...
    link: {
      ...
      '&:hover': {
        background: 'none',
        borderBottomColor: '%[!<colors.#{variantColor}.900>/!<colors.tertiary.900>]',
        color: '%[!<colors.#{variantColor}.400>/!<colors.tertiary.900>]',
        textDecoration: 'none',
      },
      '&:focus': {
      ...
      '&:active': {
        background: 'none',
        borderBottomColor: '%[!<colors.#{variantColor}.800>/!<colors.tertiary.800>]',
        color: '%[!<colors.#{variantColor}.500>/!<colors.tertiary.800>]',
        textDecoration: 'none',
      },
    },
    outline: {
