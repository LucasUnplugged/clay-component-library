...
export default {
  Button: {
    ...
    solid: {
      ...
      color: '%[!<colors.text.#{variantColor}.500>%!<colors.text.tertiary.800>]',
      '&:focus': {
        background: '%[!<colors.#{variantColor}.200>%!<colors.tertiary.1000>]',
        borderColor: '%[!<colors.#{variantColor}.50>%!<colors.tertiary.900>]',
        boxShadow: 'none',
        color: '%[!<colors.text.#{variantColor}.200>%!<colors.text.tertiary.1000>]',
      },
      '&:hover': {
      ...
      '&:active': {
        ...
        borderColor: '%[!<colors.#{variantColor}.200>%!<colors.tertiary.400>]',
        borderWidth: '2px 0 0',
  ...
  Popover: {
    content: {
      backgroundColor: '%[!<colors.neutral.900>%!<colors.neutral.200>]',
      borderColor: '%[!<colors.neutral.900>%!<colors.neutral.200>]',
      color: '%[!<colors.text.neutral.900>%!<colors.text.neutral.200>]',
      '&:focus': {
    ...
    closeButton: {},
    header: {
      borderColor: '%[!<colors.neutral.700>%!<colors.neutral.400>]',
    },
    body: {},
    footer: {
      borderColor: '%[!<colors.neutral.700>%!<colors.neutral.400>]',
